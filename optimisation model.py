...
total_heat = 2774
MJ_kWh = 0.277778
gas_price = 7.4/100*1.7
oil_price = 10.4/100*1.7
...
for f in np.r_[0:len(lifetime)]:
    ...
    b.Q1elebigM = Constraint(expr = b.Q_savings_1_ele <= (b.K_boiler[1])*10**6)
    b.Q2elebigM = Constraint(expr = b.Q_savings_2_ele <= (b.K_boiler[1])*10**6)
    ...
    b.HeatStorageCost = Constraint(expr = (((1600+3.4*price_insul/CEPCI_2023*CEPCI_2010)*(b.V_water_mash/1000 + b.V_water_laut/1000)**0.7+5800*b.K_heat + (1600*b.K_heat +210*b.A_boil**0.95 + b.K_HEX[0]*(1600)+210*b.A_mash**0.95 + b.K_HEX[1]*(1600)+210*b.A_laut**0.95))/CEPCI_2010*CEPCI_2023) == b.HexCapex)
    ...
    b.HeatbigM1 = Constraint(expr = b.K_heat*1000000 >= b.V_water_mash/1000 + b.V_water_laut/1000)
    b.HeatbigM2 = Constraint(expr = b.K_heat*1000000 >= b.A_boil)
    b.HeatbigM3 = Constraint(expr = b.K_HEX[0]*100 >= b.A_mash)
    b.HeatbigM4 = Constraint(expr = b.K_HEX[1]*100 >= b.A_laut)
    b.HeatbigM5 = Constraint(expr = b.K_HEX[0]*1000000 >= b.V_water_mash/1000)
    b.HeatbigM6 = Constraint(expr = b.K_HEX[1]*1000000 >= b.V_water_laut/1000)
    ...
    b.ADenergybigM = Constraint(expr = b.ADenergy <= b.K_boiler[0]*10**6)
    b.ADenergylimit = Constraint(expr = b.ADenergy*ADDays <= total_heat*365.25)
    b.ADCapital = Constraint(expr = b.ADCapex >= (b.K_AD*(11487)+2715*b.ADcapacity-97.4*b.ADcapacity**2)/CEPCI_2010*CEPCI_2023 + 3.4*b.ADcapacity*price_insul)
    b.ADbigM = Constraint(expr = b.K_AD*10**6 >= b.ADcapacity)
    ...
    b.DFMsavingsbigM = Constraint(expr = b.DFMSavings <= b.K_boiler[0]*10**6)
    b.DFMsize1 = Constraint(expr = b.CCS == b.CO2vol*5) # volume of DFM reactor based on the volume of gas inputted
    b.DFMsize2 = Constraint(expr = b.DFM_cost >= ((6498*b.CCS+b.K_CCS*15881-233*b.CCS**2)/CEPCI_2010*CEPCI_2023 + 3.4*b.CCS*price_insul)) # 
    b.DFMbigM = Constraint(expr = b.K_CCS*10**6 >= b.CCS)
    ...
    def buyTheThing(self,i,j):
        return b.p_buy[i,j] <= b.K_main[i,j] * 1000000
    b.buyTheThing = Constraint(b.i, b.j, rule = buyTheThing)
    
    def binder(self, i, j):
        return b.p_sell[i,j] <= (1-b.K_main[i,j])*100000
    ...
    def bigM1(self,i,j):
        return b.p_cha[i,j] <= b.K_ess[i,j] * 1000000
    b.bigM1 = Constraint(b.i, b.j, rule = bigM1)
    
    def bigM2(self,i,j):
        return b.p_dis[i,j] <= (1 - b.K_ess[i,j])*1000000
